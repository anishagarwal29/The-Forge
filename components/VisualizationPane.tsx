...
const IdleMesh = () => (
    <div className="flex flex-col items-center justify-center opacity-80">
        <div className="relative w-96 h-96 flex items-center justify-center">
            ...
            <div className="absolute inset-0 border border-magma-900/60 rounded-full border-dashed animate-[spin_20s_linear_infinite]"></div>
            {/* Inner Ring - Fast Reverse Rotate */}
            <div className="absolute inset-16 border-2 border-magma-800/50 rounded-full animate-[spin_10s_linear_infinite_reverse]"></div>

            {/* Rotating Text */}
            <div className="absolute inset-0 flex items-center justify-center animate-[spin_20s_linear_infinite]">
                <span className="font-mono text-7xl tracking-widest text-magma-900/40 font-black select-none">MESH</span>
            </div>
        </div>
    </div>
);
