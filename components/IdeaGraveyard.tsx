...
export const IdeaGraveyard: React.FC<IdeaGraveyardProps> = ({ ideas, onResurrect, onDelete, onUpdateStatus, onClearWorkspace, currentIdeaId }) => {
  return (
    <div className="h-full flex flex-col border-r border-zinc-800 bg-void w-72 shrink-0 overflow-hidden relative">
      ...
      {/* Header */}
      <div className="p-5 border-b border-zinc-800 flex items-center justify-between bg-void/80 z-10">
        ...
        >
          <div className="w-5 h-5 flex items-center justify-center border border-dashed border-zinc-700 hover:border-magma-500 rounded text-xs font-bold">
            +
          </div>
        </button>
      </div>
